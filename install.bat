...
powershell -Command "$WshShell = New-Object -comObject WScript.Shell; $Shortcut = $WshShell.CreateShortcut('%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup\Xenobot.lnk'); $Shortcut.TargetPath = 'C:\Xenobot\main.exe'; $Shortcut.WorkingDirectory = 'C:\Xenobot\'; $Shortcut.Save()"
